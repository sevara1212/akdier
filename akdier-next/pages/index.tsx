...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-roboto">
      ...
      {/* Header/NavBar */}
      <header className="bg-[#0a1a3c] flex items-center justify-between px-4 py-1 w-full shadow-md">
        ...
        <div className="flex items-center space-x-2">
          <div className="relative">
            <input type="text" placeholder="Search..." className="rounded-full px-3 py-1 pl-7 border border-white/40 bg-white text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white/60 transition-colors text-xs w-44" />
            <svg className="absolute left-2 top-1/2 transform -translate-y-1/2 w-3 h-3 text-gray-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-6xl mx-auto">
            ...
            {[
              { title: 'Waste Management', img: '/waste.png' },
              { title: 'Transportation', img: '/transportation.png' },
              { title: 'Liquidation of pollution', img: '/liquidation.png' },
              { title: 'Cleaning the reserves', img: '/cleaning.png' },
              { title: 'Collection and Utilisation', img: '/collection.png' },
              { title: 'Construction', img: '/construction.png' }
            ].map((service, i) => (
              <div key={i} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow">
                <div className="relative w-full h-28">
                  <img src={service.img} alt={service.title} className="absolute inset-0 w-full h-full object-cover filter grayscale hover:grayscale-0 transition-all duration-300" />
                </div>
                <div className="p-4">
                  <div className="font-semibold text-base mb-1">{service.title}</div>
                  <div className="text-gray-600 text-xs">Briefly talk about your firm's services here.</div>
                </div>
              </div>
            ))}
            </div>
      ...
      {/* Clients Section */}
      <section 
        className="bg-white w-full flex flex-col justify-start overflow-hidden"
        style={{ height: '720px' }}
      >
      ...
      {/* Footer */}
      <footer 
        className="bg-[#0a1a3c] text-white w-full overflow-hidden"
        style={{ height: '320px' }}
      >
        <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-16 h-full flex flex-col justify-center">
          {/* Two Column Layout - Office and Business Hours */}
          <div className="flex flex-col md:flex-row justify-between items-start mb-10 gap-12">
            {/* Left Column - Office Information */}
            <div className="min-w-0 flex-1">
              <div className="font-bold mb-4 text-white" style={{ fontFamily: 'Garet, sans-serif', fontSize: '26px' }}>Office</div>
              <div className="text-white leading-relaxed space-y-2" style={{ fontFamily: 'Garet, sans-serif', fontSize: '14px' }}>
            ...
            <div className="min-w-0 flex-1">
              <div className="font-bold mb-4 text-white" style={{ fontFamily: 'Garet, sans-serif', fontSize: '26px' }}>Business hours</div>
              <div className="text-white leading-relaxed space-y-2" style={{ fontFamily: 'Garet, sans-serif', fontSize: '14px' }}>
          ...
          <div className="border-t border-white/20 pt-6">
            <div className="font-bold mb-4 text-white" style={{ fontFamily: 'Garet, sans-serif', fontSize: '22px' }}>Get social</div>
